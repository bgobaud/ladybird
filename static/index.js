...
/**
 * update the array with the criteria given by the user
 * @param {Object} document document DOM 
 */
function updateArray(document) {
  ...
  const filteredData = filterData(allJson, {
    ageMin,
    ageMax,
    eyeColor: eyecolorSelectValue,
  });
